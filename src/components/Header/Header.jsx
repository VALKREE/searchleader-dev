...
const Header = () => {
    const {isCount} = useContext(CartContext);
    return (
        <header className={classes.header}>
            <Link to='./'>
                <img src="./logo.svg" alt="" className={classes.image}/>
            </Link>
            <Link to='/cart' className={classes.toCart}>
                <svg width="28" height="23" viewBox="0 0 28 23" fill="#35383A" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <p className={classes.cartText}>Корзина</p>
                {
                    isCount>0
                        ?
